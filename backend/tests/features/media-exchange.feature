...
Scenario: Obtendo histórico de envio de mídias
    ...
    When uma requisão GET for enviada para "/api/messages/Bia/Leticia"
...
Scenario: Remoção de mídia inexistente
    ...
    When uma requisição DELETE for enviada para "/api/messages/Bia/Leticia/123"
...
Scenario: Remoção de mídia enviada por outro usuário
    ...
    When uma requisição DELETE for enviada para "/api/messages/Leticia/Bia/123"
    Then o status da resposta deve ser "500"
